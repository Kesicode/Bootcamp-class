  ...
  return (
    ...
    >
      ...
      <div className="border-b border-black/[0.06] dark:border-white/[0.06] pb-6 mb-6">
        <p className="font-mono text-[10px] tracking-[0.3em] text-black/30 dark:text-white/30 uppercase mb-3">CIRCUITRON // SYSTEM_SETTINGS</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1">
          <div className="border border-black/10 dark:border-white/10 rounded-2xl p-6 bg-transparent flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-black/50 dark:text-white/50 mb-8">{user?.role === 'admin' ? 'Administrator' : 'Student'}</p>
